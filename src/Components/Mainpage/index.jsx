  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        setCategoryCount(categoryRes.data?.count || 0);
        setSubcategoryCount(subcategoryRes.data?.count || 0);
        setQuestionCount(questionRes.data?.count || 0);
      
        localStorage.setItem("category", categoryRes.data?.count || 0);
        localStorage.setItem("subcategory", subcategoryRes.data?.count || 0);
        localStorage.setItem("question", questionRes.data?.count || 0);
      } catch (error) {
